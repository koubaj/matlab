...
%% 1. Vytvořte matici 'x' s rozmerem NxN, která bude pro každý svůj řádek 
%   obsahovat vektor od -2 do 1
N = 6000;
x = repmat(linspace(-2,1,N),N,1);

%% 2. Napiste matici 'y' s rozměrem NxN, která bude pro každý svůj sloupec
%   obsahovat vektor od -2 do 1.5 
